...
import { deepcopy, transformDict } from "./utils";
...
const GPTImage1Settings: ModelSettingsDict = {
  fullName: "GPT-Image-1 (OpenAI)",
  schema: {
    type: "object",
    required: ["shortname"],
    properties: {
      ...
      size: {
        ...
        description:
          "The size of the generated images. WARNING: Currently, all images are stored in browser memory. Be careful: you may run out of memory fast if you're generating a lot of images.",
        default: "auto",
      },
      quality: {
        type: "string",
        ...
        description:
          "The quality of the image that will be generated. high, medium and low are supported for gpt-image-1.",
        default: "auto",
      },
      background: {
        type: "string",
      ...
      output_compression: {
        ...
        description:
          "The compression level (0-100%) for the generated images. This parameter is only supported for webp or jpeg output formats, and defaults to 100.",
        minimum: 0,
        maximum: 100,
        default: 100,
      },
  ...
  uiSchema: {
    ...
    model: {
      "ui:help": "Defaults to gpt-image-1.",
      "ui:widget": "datalist",
    },
    size: {
